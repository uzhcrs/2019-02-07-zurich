...
venue: "University of Zurich"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Seminarraum Y27-H-25, Irchel Campus, Winterthurerstrasse 190, 8057 Zürich"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "47.3966, 8.55013"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Lachlan Deer", "Julian Langer"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stephan Schmeing"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["eva.furrer@uzh.ch", "lachlan.deer@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2019-02-07-zurich           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<figure>
  <a href="https://www.crs.uzh.ch/en.html">
  <IMG SRC="fig/UZH_logo_borderGreen.png" ALIGN="top" width="160" height="160" />
  </a>
<figure/>
<p>This Software Carpentry Workshop is supported by the Center for Reproducible Science at the University of Zurich.</p>
<hr/>
